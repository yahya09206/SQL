...
SELECT * FROM EMPLOYEES ORDER BY 1 ASC; -- SAME AS ORDERING BY EMPLOYEE_ID DESC BECAUSE IT'S IN FIRST COLUMN

-- USE INDEX TO SORT BY SALARY COLUMN ASC ORDER
SELECT * FROM EMPLOYEES ORDER BY 8;

-- USING PARTIAL SEARCH WITH WILDCARD : LIKE %
-- FIND OUT ALL EMPLOYEE NAMES THAT START WITH 'A'
SELECT FIRST_NAME FROM EMPLOYEES WHERE FIRST_NAME LIKE 'A%';

-- FIND NAMES THAT END WITH LOWERCASE A
SELECT FIRST_NAME FROM EMPLOYEES WHERE FIRST_NAME LIKE '%a';

-- FIND OUT ALL EMPLOYEES FIRST_NAME STARTS WITH L AND ENDS WITH A 'L%a'
SELECT FIRST_NAME FROM EMPLOYEES WHERE FIRST_NAME LIKE 'L%a';

-- FIND OUT ALL EMPLOYEES FIRST_NAME THAT CONTAINS V : '%v%'
SELECT FIRST_NAME FROM EMPLOYEES WHERE FIRST_NAME LIKE '%v%';

-- FIND OUT ALL PHONE NUMBERS THAT START WITH 650 IN EMPLOYEES TABLE
SELECT PHONE_NUMBER FROM EMPLOYEES WHERE PHONE_NUMBER LIKE '650%';
-- FIND OUT ALL PHONE NUMBER THAT CONTAINS 44
...
-- FIND OUT EMPLOYEES NAMES THAT STARTS WITH T
SELECT FIRST_NAME FROM EMPLOYEES WHERE FIRST_NAME LIKE 'T%';

-- FIND OUT EMPLOYEES NAMES THAT START WITH T AND FOLLOWED BY SINGLE CHARACTER
SELECT FIRST_NAME FROM EMPLOYEES WHERE FIRST_NAME LIKE 'T_';

-- FIND OUT EMPLOYEES FIRST_NAME STARTS WITH A AND HAVE EXACTLY 4 CHARACTERS TOTAL
