...
SELECT COUNT(FIRST_NAME) FROM EMPLOYEES; -- 107 TOTAL ROW NUMBERS
...
-- IF YOU WANT TO GET ALL ROW, ALWAYS USE COUNT(*) INSTEAD

-- GET MAX SALARY, MIN SALARY, AVG, SUM FROM EMPLOYEES TABLE
...
-- MULTI ROW FUNCTIONS | GROUP FUNCTIONS | AGGREGATE FUNCTIONS(ALL SAME THING)
-- IF NOTHING IS SPECIFIED, GROUP FUNCTION WILL RETURN ONE RESULT FOR WHOLE TABLE
-- WE CAN HOWEVER, DIVIDE THE RESULT USING GROUP BY COLUMN_NAME
-- THEN IT WILL RETURN ONE RESULT PER GROUP
-- GROUP BY CAN ONLY BE USED ALONG WITH GROUP FUNCTIONS (COUNT, MAX, MIN, AVG, SUM)

-- FIND OUT EMPLOYEE COUNT FOR EACH DEPARTMENT
SELECT DEPARTMENT_ID,  COUNT(*)
FROM EMPLOYEES
GROUP BY DEPARTMENT_ID
-- OPTIONALLY ORDER THE RESULT BY 2ND COLUMN
ORDER BY 2;

-- FIND OUT THE COUNT OF EMPLOYEES IN JOB_ID IN EMPLOYEES TABLE
