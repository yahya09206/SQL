...
-- FIND OUT THE COUNT OF EMPLOYEES IN EACH JOB_ID IN EMPLOYEES TABLE
SELECT JOB_ID, COUNT(*) FROM EMPLOYEES GROUP BY JOB_ID;

-- FIND OUT MAX SALARY OF EACH DEPARTMENT IN EMPLOYEES TABLE
SELECT DEPARTMENT_ID, MAX(SALARY) FROM EMPLOYEES GROUP BY DEPARTMENT_ID;

-- FIND OUT SUM SALARY OF EACH DEPARTMENT IN EMPLOYEES TABLE
SELECT DEPARTMENT_ID, SUM(SALARY) FROM EMPLOYEES GROUP BY DEPARTMENT_ID;

-- FIND OUT SUM OF ALL SALARIES FOR EACH JOB_ID IN EMPLOYEES TABLE
SELECT JOB_ID, SUM(SALARY) FROM EMPLOYEES GROUP BY JOB_ID;

-- DO ALL IN ONE SELECT
SELECT DEPARTMENT_ID, SUM(SALARY), MAX(SALARY), MIN(SALARY), AVG(SALARY) FROM EMPLOYEES GROUP BY DEPARTMENT_ID;

-- FIND OUT COUNT OF EMPLOYEE IN EACH DEPARTMENT
-- ONLY DISPLAY THE RESULT IF THE COUNT IS MORE THAN 5

-- IF WE WANT TO FURTHER FILTER ALREADY AGGREGATED RESULT AFTER THE GROUP BY
-- WE CAN USE 'HAVING' --> 'HAVING SOME_CONDITION IS TRUE'

-- FIND OUT THE COUNT OF EMPLOYEE IN EACH DEPARTMENT
-- ONLY DISPLAY THE RESULT IF THE COUNT IS MORE THAN 5
SELECT DEPARTMENT_ID, COUNT(*) FROM EMPLOYEES GROUP BY DEPARTMENT_ID HAVING COUNT(*) > 5;

-- FIND OUT THE SUM OF ALL SALARY IN EACH DEPARTMENT
...
-- FIND OUT THE AVERAGE OF ALL EMPLOYEE SALARIES IN EACH DEPARTMENT
...
-- FIND OUT THE COUNT OF EMPLOYEES MAKE MORE THAN 10000
SELECT COUNT(*) FROM EMPLOYEES WHERE SALARY > 10000 GROUP BY JOB_ID;
-- GROUP THE RESULT BY JOB_ID
SELECT JOB_ID, COUNT(*) FROM EMPLOYEES WHERE SALARY > 10000 GROUP BY JOB_ID;

-- FIND OUT HOW MANY LOCATIONS IN EACH COUNTRY USING LOCATIONS TABLE
-- IT SHOULD DISPLAY THESE TWO COLUMNS: COUNTRY_ID AND COUNT
-- FILTER ABOVE RESULT ONLY DISPLAY IF THE COUNT IS MORE THAN 3
SELECT COUNTRY_ID, COUNT(*) FROM LOCATIONS GROUP BY COUNTRY_ID HAVING COUNT(*) > 3;

-- FIND OUT FREQUENCY OF FIRST_NAME IN EMPLOYEES TABLE
