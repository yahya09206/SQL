...
-- INCLUDING THOSE DEPARTMENTS THAT DO NOT HAVE ANY MATCHING EMPLOYEES
-- RIGHT OUTER JOIN WILL RETURN ALL FROM RIGHT SIDE
SELECT E.FIRST_NAME, E.DEPARTMENT_ID, D.DEPARTMENT_NAME
FROM EMPLOYEES E -- E HERE IS NICK NAME FOR EMPLOYEES TABLE
RIGHT OUTER JOIN DEPARTMENTS D on E.DEPARTMENT_ID = D.DEPARTMENT_ID; -- FOREIGN KEY RELATIONSHIP
